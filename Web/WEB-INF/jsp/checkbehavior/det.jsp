		...
		<form id="addfrm" name="addfrm" method="post">
			<table style="width: 100%">
				<tr>
					...
					<td width="50%">
						<input id="checktime" name="bean.checktime" class="easyui-validatebox" type="text" data-options="required:true" style="width: 100%;background-color: #E6E4DA" readonly="readonly"/>
					</td>
					<td colspan="2">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td width="50%">
						<input id="checktype_desc" name="bean.checktype_desc" class="easyui-validatebox" type="text" data-options="required:true" style="width: 100%;background-color: #E6E4DA" readonly="readonly"/>
					</td>
					<td colspan="2">
						&nbsp;
					</td>
