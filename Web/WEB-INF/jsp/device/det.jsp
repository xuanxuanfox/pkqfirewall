		...
		<form id="addfrm" name="addfrm" method="post">
			<table style="width: 100%">
				...
				<tr>
					...
					<td width="30%">
						<input id="type" name="bean.type" class="easyui-validatebox" type="text" data-options="required:true" style="width: 100%;background-color: #E6E4DA" readonly="readonly"/>
					</td>
					<td colspan="2">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<textarea id="description" name="bean.description" style="width: 100%;height: 120px;background-color: #E6E4DA" readonly="readonly" data-options="required:false"  class="easyui-validatebox"></textarea>
					</td>
				</tr>
				<tr>
